    ...
    private fun setupRecyclerView(view: View) {
        ...
        private val itemTouchHelper = ItemTouchHelper(object : ItemTouchHelper.SimpleCallback(
            ...
            override fun onMove(
                ...
                val topPosition = targetViewHolder.adapterPosition

                Collections.swap(favoriteCityList, fromPosition, topPosition)

                recyclerView.adapter?.notifyItemMoved(fromPosition, topPosition)
                return true
